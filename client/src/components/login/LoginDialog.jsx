...
const LoginDialog = ({ open, setOpen }) => {
    ...
    const [signup, setSignnup] = useState(signupInitialValues);
    ...
    const onInputChange = (e) => {
        setSignnup({...signup, [e.target.name]: e.target.value });
    }
            ...
            <Component>
                <Box style={{ display: 'flex', height: '100%' }}>
                    ...
                    <Wrapper>
                        ...
                        <Text>By continuing, you agree to Flipkart's Terms of Use and Privacy and Policy.</Text>
